...
class Department{
  ...
  Department({this.id,this.disabled,this.online_hours_active,this.name,
  this.email,this.mod_start_hour,this.mod_end_hour,this.tud_start_hour,
  this.tud_end_hour,this.wed_start_hour,this.wed_end_hour,this.thd_start_hour,
  this.thd_end_hour,this.frd_start_hour,this.frd_end_hour,this.sad_start_hour,this.sad_end_hour,
  this.sud_start_hour,this.sud_end_hour});

  int id;
  bool disabled,online_hours_active;
  String name,email,mod_start_hour,mod_end_hour,tud_start_hour,
  ...
  bool get sundayActive =>_timeAlreadySet(this.sud_start_hour, this.sud_end_hour);
  bool get mondayActive =>_timeAlreadySet(this.mod_start_hour, this.mod_end_hour);
  bool get tuesdayActive =>_timeAlreadySet(this.tud_start_hour, this.tud_end_hour);
  bool get wednesdayActive =>_timeAlreadySet(this.wed_start_hour, this.wed_end_hour);
  bool get thursdayActive =>_timeAlreadySet(this.thd_start_hour, this.thd_end_hour);
  bool get fridayActive =>_timeAlreadySet(this.frd_start_hour, this.frd_end_hour);
  bool get saturdayActive =>_timeAlreadySet(this.sad_start_hour, this.sad_end_hour);
