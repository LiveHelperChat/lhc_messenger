...
class Message {
  ...
  static final Map<String,String> columns = {"db_id":"id","db_time":"time",
  "db_chat_id":"chat_id","db_user_id":"user_id", "db_msg":"msg","db_name_support": "name_support"};

  int id,chat_id,user_id,time;
  String msg,name_support;

  Message({this.id,this.chat_id,this.user_id,this.time,this.msg,this.name_support});
