...
class Bubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg =message.user_id == 0 ? Theme.of(context).primaryColorLight : message.user_id > 0 ? Colors.white : Colors.greenAccent;
    final align = message.user_id == 0 ? CrossAxisAlignment.start :
    message.user_id > 0 ? CrossAxisAlignment.end : CrossAxisAlignment.center ;

    final icon =  Icons.done;
    final radius = message.user_id == 0 ? const BorderRadius.only(
          ...
          child:new Column(
            ...
            children: <Widget>[
              ...
              new Padding(
                ...
                child: new Text(dateFormatter.format(
