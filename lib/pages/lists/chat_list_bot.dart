...
class BotListWidget extends StatefulWidget {
  ...
  @override
  _BotListWidgetState createState() => new _BotListWidgetState();
}
      ...
      if (state is ChatListLoaded) {
        if (state.isLoading) {
          ...
          return ListView.builder(
              itemCount: state.botChatList.length,
              itemBuilder: (BuildContext context, int index) {
                if (state.botChatList.isNotEmpty) {
                  Chat chat = state.botChatList[index];
